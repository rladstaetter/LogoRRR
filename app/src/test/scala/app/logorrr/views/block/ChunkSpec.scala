...
class ChunkSpec extends AnyWordSpec {
  ...
  def mkTestChunks(nrEntries: Int
    ...
    Chunk.mkChunks(ChunkSpec.mkTestLogEntries(nrEntries), width, height, blocksize)
  }
