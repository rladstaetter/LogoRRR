...
build package app.logorrr.dist.linux:app-image,app.logorrr.dist.linux:rpm,app.logorrr.dist.linux:deb,app.logorrr.dist.linux.flatpak:flatpak-package,app.logorrr.dist.linux:graal-linux
