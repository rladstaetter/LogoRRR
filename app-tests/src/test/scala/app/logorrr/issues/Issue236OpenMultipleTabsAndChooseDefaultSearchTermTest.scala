...
class Issue236OpenMultipleTabsAndChooseDefaultSearchTermTest
  ...
  @Test def testIssue236(): Unit =
    ...
    val firstFilterTab1 = SearchTermButton.uiNode(TestFiles.simpleLog0, TestSettings.DefaultSearchTerms.head)
    ...
    val firstFilterTab2 = SearchTermButton.uiNode(TestFiles.simpleLog1, TestSettings.DefaultSearchTerms.head)
