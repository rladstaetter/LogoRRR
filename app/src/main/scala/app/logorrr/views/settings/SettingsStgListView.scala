...
class SettingsStgListView(fileId: FileId, searchTermGroups: ObservableList[SearchTermGroup]) extends ListView[SearchTermGroup] :
  ...
  def getSearchTermGroups : ObservableList[SearchTermGroup] = searchTermGroups
